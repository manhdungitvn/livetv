...
import 'package:livetv/business_logic/utils/show_snackbar.dart';
import 'package:livetv/core/consts.dart';
import 'package:livetv/presentation/widgets/main_appbar.dart';
import 'package:livetv/presentation/widgets/setting/setting_card.dart';
...
class Setting extends StatelessWidget {
  ...
  void openTelegram() async {
    if (!await launch("https://telegram.me/manhdungitvn"))
      throw 'Could not launch telegram';
  }

  void openGithub() async {
    if (!await launch("https://github.com/manhdungitvn"))
